...
<head>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="viewcourseassets/images/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="viewcourseassets/images/apple-touch-icon.png">
    ...
    <link rel="stylesheet" href="viewcourseassets/css/bootstrap.min.css">
    <link rel="stylesheet" href="viewcourseassets/css/font-awesome.min.css">
    <link rel="stylesheet" href="viewcourseassets/css/prettyPhoto.css">
    <link rel="stylesheet" href="viewcourseassets/css/animate.css">
    <link rel="stylesheet" href="style.css">

    <!--[if lt IE 9]>
    <script src="viewcourseassets/js/vendor/html5shiv.min.js"></script>
    <script src="viewcourseassets/js/vendor/respond.min.js"></script>
    <![endif]-->
...
{{--<!-- LOADER -->--}}
{{--<div id="preloader">--}}
{{--    <img class="preloader" src="viewcourseassets/images/loader.gif" alt="">--}}
{{--</div><!-- end loader -->--}}
{{--<!-- END LOADER -->--}}
            ...
            <nav class="navbar navbar-default yamm">
                <div class="navbar-header">
                    ...
                    <div class="logo-normal">
                        <a class="navbar-brand" href="index.html"><img src="viewcourseassets/images/logo-dark.png" alt=""></a>
                    </div>
                </div>
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="menu-widget text-center">
                                                    <div class="image-wrap entry">
                                                        <img src="viewcourseassets/upload/course_01.jpg" alt="" class="img-responsive">
                                                        <div class="magnifier">
                ...
                <div class="row">
                    <div class="col-md-6 shop-media">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="image-wrap entry">
                                    <img src="viewcourseassets/upload/single_shop_01.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <a rel="prettyPhoto[inline]" href="viewcourseassets/upload/single_shop_01.jpg" title=""><i class="flaticon-add"></i></a>
                                    </div>
                                </div><!-- end image-wrap -->
                            </div>
                        </div><!-- end row -->
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <div class="image-wrap entry">
                                    <img src="viewcourseassets/upload/single_shop_02.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <a rel="prettyPhoto[inline]" href="viewcourseassets/upload/single_shop_02.jpg" title=""><i class="flaticon-add"></i></a>
                                    </div>
                                </div><!-- end image-wrap -->
                            </div>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <div class="image-wrap entry">
                                    <img src="viewcourseassets/upload/single_shop_03.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <a rel="prettyPhoto[inline]" href="viewcourseassets/upload/single_shop_03.jpg" title=""><i class="flaticon-add"></i></a>
                                    </div>
                                </div><!-- end image-wrap -->
                            </div>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <div class="image-wrap entry">
                                    <img src="viewcourseassets/upload/single_shop_04.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <a rel="prettyPhoto[inline]" href="viewcourseassets/upload/single_shop_04.jpg" title=""><i class="flaticon-add"></i></a>
                                    </div>
                                </div><!-- end image-wrap -->
                            </div>
                        </div><!-- end row -->
                    ...
                    <div class="row blog-grid shop-grid">
                        <div class="col-md-3">
                            <div class="course-box shop-wrapper">
                                <div class="image-wrap entry">
                                    <img src="viewcourseassets/upload/shop_01.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                        ...
                        <div class="col-md-3">
                            <div class="course-box shop-wrapper">
                                <div class="image-wrap entry">
                                    <img src="viewcourseassets/upload/shop_02.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <a href="shop-single.html" title=""><i class="flaticon-add"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="course-box shop-wrapper">
                                <div class="image-wrap entry">
                                    <img src="viewcourseassets/upload/shop_03.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <a href="shop-single.html" title=""><i class="flaticon-add"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="course-box shop-wrapper">
                                <div class="image-wrap entry">
                                    <img src="viewcourseassets/upload/shop_04.jpg" alt="" class="img-responsive">
                                    <div class="magnifier">
                                        <a href="shop-single.html" title=""><i class="flaticon-add"></i></a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="widget clearfix">
                        ...
                        <div class="newsletter-widget">
                            ...
                            <img src="viewcourseassets/images/payments.png" alt="" class="img-responsive">
                        </div><!-- end newsletter -->
                    </div><!-- end widget -->
                </div><!-- end col -->
    ...
    <div class="copyrights">
        <div class="container">
            <div class="clearfix">
                <div class="pull-left">
                    <div class="cop-logo">
                        <a href="#"><img src="viewcourseassets/images/logo.png" alt=""></a>
                    </div>
                </div>
...
<!-- jQuery Files -->
<script src="viewcourseassets/js/jquery.min.js"></script>
<script src="viewcourseassets/js/bootstrap.min.js"></script>
<script src="viewcourseassets/js/animate.js"></script>
<script src="viewcourseassets/js/jquery.prettyPhoto.js"></script>
<script src="viewcourseassets/js/custom.js"></script>
